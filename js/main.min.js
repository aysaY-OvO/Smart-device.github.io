...
var _phoneMask = require("./utils/phone-mask");
// ---------------------------------
var headerLogotype = document.querySelector('[data-logotype="header-logotype"]');
var previewButton = document.querySelector('[data-button="preview-button"]');
var accordionParent = document.querySelector('.accordion');
var aboutBlock = document.querySelector('.about');
var aboutHiddenText = aboutBlock.querySelectorAll('.is-hidden');
var aboutButton = aboutBlock.querySelector('.about__button');
var mobileWidthOnlyHidden = aboutBlock.querySelector('.mobile-width-hidden');
var productsTitle = document.querySelector('[data-title="products-title"]');
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var onChangeHeaderLogotype = function onChangeHeaderLogotype() {
  ...
  var onChangePreviewButton = function onChangePreviewButton() {
    if (tabletBreakpoint.matches) {
  ...
  var accordionsBreakpointChecker = function accordionsBreakpointChecker() {
    if (tabletBreakpoint.matches) {
      _initAccordion.accordions.closeAllAccordion(accordionParent);
    } else {
      _initAccordion.accordions.fullUpdate();
    }
  };
  var showTabletText = function showTabletText() {
    if (tabletBreakpoint.matches) {
  ...
  var showText = function showText(btn, content) {
  ...
  var onChangeProductsTitle = function onChangeProductsTitle() {
    if (tabletBreakpoint.matches) {
  ...
  window.addEventListener('load', function () {
    tabletBreakpoint.addEventListener('change', showTabletText);
    tabletBreakpoint.addEventListener('change', accordionsBreakpointChecker);
    tabletBreakpoint.addEventListener('change', onChangeProductsTitle);
    tabletBreakpoint.addEventListener('change', onChangePreviewButton);
    tabletBreakpoint.addEventListener('change', onChangeHeaderLogotype);
    tabletBreakpoint.addEventListener('change', removeTabIndex);
    (0, _phoneMask.initPhoneMask)();
    aboutHiddenText.forEach(function (text) {
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./utils/ios-vh-fix":15,"./utils/phone-mask":16}],2:[function(require,module,exports){
"use strict";
