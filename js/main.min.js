...
var productsTitle = document.querySelector('.products__title');
window.addEventListener('DOMContentLoaded', function () {
  // Utils
  // ---------------------------------
  var tabletBreakpoint = window.matchMedia('(max-width: 769px)');
  ...
  var changeProductsTitle = function changeProductsTitle() {
    if (tabletBreakpoint.matches) {
